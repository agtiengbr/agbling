...
class ApiBlingListStockResponseSuccess implements DenormalizerInterface
{
    public function denormalize($data, $type, $format = null, array $context = [])
    {
        ...
        foreach ($obj->getData() as $apiProd)  {
            $ret[] = $s->denormalize($apiProd, StockInfo::class, $format, $context);
        }
    ...
    {
        return $type === ListaEstoquesResponseSuccess::class;
    }
}