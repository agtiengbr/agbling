...
class BaseAgBling extends AgModule
{
    ...
    public function install()
    {
        $r = parent::install();
        if ($r) {
            // Keep the local primary key generated by MySQL. id_remote is the
            // identifier returned by Bling and is stored in its own column.
            $r = Db::getInstance()->execute(
                "ALTER TABLE " . _DB_PREFIX_ . "agbling_order MODIFY id_agbling_order BIGINT UNSIGNED NOT NULL AUTO_INCREMENT"
            );
        }
